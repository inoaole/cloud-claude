...
const status = {
  ...
  Peer: {
    ...
    b: { HostName: 'my-desktop', DNSName: 'my-desktop.tail.ts.net.', TailscaleIPs: ['100.99.1.2'], Online: false },
  },
};
...
test('peer offline → asleep (no TCP probe needed)', async () => {
  const dev = { id: 'desktop', label: 'Desktop', tailnet: 'my-desktop', enabled: true };
